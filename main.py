...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='WeightedGCL', help='name of models')
    parser.add_argument('--dataset', type=str, default='pinterest',
                        help='The datasets can be:')
    # 'pinterest', 'amazon-books', 'alibaba'
    ...
    if args.dataset in ['pinterest', 'amazon-books', 'alibaba']:
